@extends('layouts.app', ['title' => 'Rekap_suara_partai - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.rekap_suara_partai.create') }}">TAMBAH</a>
            </button>
            <div class="relative mx-4">
                ...
                <form action="{{ route('admin.rekap_suara_partai.index') }}" method="GET">
        ...
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow-sm rounded-lg overflow-hidden">
                ...
                @if ($rekap_suara_partais->hasPages())
                <div class="bg-white p-3">
                    {{ $rekap_suara_partais->links('vendor.pagination.tailwind') }}
                </div>
                @endif
            </div>
        </div>
    ...
    function destroy(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //ajax delete
                jQuery.ajax({
                    url: `/admin/rekap_suara_partai/${id}`,
                    data: {
                        "id": id,
                        "_token": token
                    },
