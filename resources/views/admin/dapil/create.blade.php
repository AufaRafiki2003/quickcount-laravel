@extends('layouts.app', ['title' => 'Tambah dapil - Admin'])
            ...
            <form action="{{ route('admin.dapil.store') }}" method="POST" >
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="nama_dapil" value="{{ old('nama_dapil') }}" placeholder="Dapil Baitussalam">
                        @error('nama_dapil')
