@extends('layouts.app', ['title' => 'Tambah kelurahan - Admin'])

@section('content')
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold capitalize">TAMBAH KELURAHAN</h2>
            <hr class="mt-4">
            <form action="{{ route('admin.kelurahan.store') }}" method="POST" >
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        <label class="text-gray-700" for="nama_kel">NAMA KELURAHAN</label>
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="nama_kel" value="{{ old('nama_kel') }}" placeholder="nama_kel">
                        @error('nama_kel')
